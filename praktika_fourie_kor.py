...
##                plt.plot(x_val,x,color='black')

                plt.plot(x_val,x)
##                y_tek_val=fourier(koef_kor[ind][0],koef_kor[ind][1]+1)
                j=0
                
##                for i in range(koef_kor[ind][0],koef_kor[ind][1]+1):
##                    y_val[i]=y_tek_val[j]
##                    j+=1

                plt.plot(y_val,y, color="red")
                
                plt.plot((x_val[N1],y_val[koef_kor[ind][0]]),(x[N1],y[koef_kor[ind][0]]),color='green')
                plt.plot((x_val[N2],y_val[koef_kor[ind][1]]),(x[N2],y[koef_kor[ind][1]]),color='green')
                plt.show()
